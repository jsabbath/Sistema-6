...
$content = " <table border='0' class='table'>
					...
					<tr>
						<td align='justify'>Ha sido autorizado para tomar la modalidad de EXAMEN DE REGULARIZACION POR EVALUACION PERMANENTE POR ESTUDIOS INDEPENDIENTE - de acuardo
...
$html2pdf->Output('evaluacion_per_x_Est_independientes.pdf');
?>