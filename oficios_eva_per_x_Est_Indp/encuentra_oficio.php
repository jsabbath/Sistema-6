...
$per=mysql_query("select periodo,matricula from eva_permanente_por_est_independientes where periodo='$periodo' and matricula='$matricula'"); 
if(mysql_num_rows($per)>0) 
{ 
  
	  $ofi=mysql_query("select * from eva_permanente_por_est_independientes where periodo='$periodo' and matricula='$matricula'"); 
