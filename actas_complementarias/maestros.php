<?php 
	$msj=$_GET['msj']; 
	if ($msj == 1) {
		$msj="<div class='alert alert-danger'>El Maestro ya Existe</div>";
	}
	if ($msj == 2) {
		$msj="<div class='alert alert-success'>Se Agrego Exitosamente al Maestro</div>";
	}
?>
<!doctype html>
<html lang="en">
<head>
	...
	<script type="text/javascript">
	    function Maestro(noemp){
	        document.getElementById('iframe3').src= 'c_maestro.php?noemp=' + noemp;
	    }
    </script>
</head>
<body>
	<div class="well">
		<form action="maestro_proceso.php" id="form" method="POST">
			<table border="0" class="table">
				<tr>
					<td align="center" colspan="2"><img src="img/user.png" width="40" alt="Alumno"></td>
				</tr>
				<tr>
					<td align="center"><label for="noemp">No. Empleado:</label></td>
					<td align="center"><input type="text" id="noemp" onblur="Maestro(this.value);" class="form-control" name="noemp" placeholder="No. Empleado" required></td>
				</tr>
				<tr>
	...
	<iframe id="iframe3" src="c_maestro.php" width="0" height="0" frameborder="0"></iframe>
</body>
</html>
