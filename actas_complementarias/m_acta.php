...
<body>
    ...
    <div class="container">
      <div class="jumbotron">
        ...
        <div class="container">
        	<div class="col-md-4">
        		<form action="save_m_acta.php" method="POST" class="form-horizontal" role="form" name="form1">
        			<table class="table">
                        <tr>
                            <td colspan="2">
                                <select name="tipo_examen" class="form-control" id="tipo_examen">
        				...
        				<tr>
        					...
        					<td><input type="date" name="fecha" id="fecha" class="form-control" placeholder="Fecha" value="<?php echo $dia2.'/'.$mes2.'/'.$ano2; ?>"></td>
        				</tr>
        				<tr>
        					<td><label for="noemp"><h5>No. Emp:</h5></label></td>
        					<td><input type="text" name="noemp" onblur="Maestro(this.value);" id="noemp" class="form-control" placeholder="No. Empleado" value="<?php echo $noemp2; ?>"></td>
        				</tr>
        				<tr>
        					<td><label for="emp"><h5>Maestro:</h5></label></td>
        					<td><input type="text" name="emp" id="nombre_maestro" class="form-control" placeholder="Maestro" value="<?php echo $nombre_emp2; ?>"></td>
        				</tr>
        				<tr>
        					<td><label for="carrera"><h5>Carrera:</h5></label></td>
        					<td>
        						<select name="carrera" class="form-control" id="carrera" onChange="materias()">
        				...
        				<tr>
        					...
        					<td><input type="text" name="id_materia" id="id_materia" class="form-control" placeholder="Clave Materia" value="<?php echo $clave_materia2; ?>"></td>
        				</tr>
        				<tr>
        					<td><label for="nombre_materia"><h5>Materia:</h5></label></td>
        					<td><input type="text" name="nombre_materia" id="nombre_materia" class="form-control" placeholder="Materia" value="<?php echo $materia2; ?>"></td>
        				</tr>
        				<tr>
        					<td><label for="plan"><h5>Plan:</h5></label></td>
        					<td><input type="text" name="plan" id="plan" class="form-control" placeholder="Plan" value="<?php echo $plann2; ?>"></td>
        				</tr>
        				<tr>
        					<td><label for="etapa"><h5>Etapa:</h5></label></td>
        					<td><input type="text" name="etapa" id="etapa" class="form-control" placeholder="Etapa" value="<?php echo $etapa2; ?>"></td>
        				</tr>
        				<tr>
        					<td><label for="grupo"><h5>Grupo:</h5></label></td>
        					<td><input type="text" name="grupo" id="grupo" class="form-control" placeholder="Grupo" value="<?php echo $grupo2; ?>"></td>
        				</tr>
        				<tr>
        	...
        	<div class="col-md-8">
        		...
        		<table class="table">
                    ...
                    <?php
                        ...
                        $ver = mysql_query("SELECT * FROM acta_detalles WHERE no_acta=".$_POST['m_acta']);
