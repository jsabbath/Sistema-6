...
<body>
	...
	<?php
		...
		if ($_GET['lista'] == null) {
			$find = mysql_query("SELECT * FROM lista");
			...
			<form action="" method="POST">
				<table class="table">
					<tr>
						<td></td>
						<td>
			<input type="text" readonly="readonly" class="form-control" name="id_lista" value="<?php echo $lista;?>">
						</td>
						<td>
							<input type="text" readonly="readonly" class="form-control" name="periodo"  value="<?php echo$periodo;?>">
						</td>
						<td>
							<input type="text" readonly="readonly" class="form-control" name="tipo" value="<?php echo$tipo;?>">
						</td>
						<td colspan="2">
							<input type="text" readonly="readonly" class="form-control" name="examen" value="<?php echo$examen;?>">
						</td>
						<td>
							<input type="text" readonly="readonly" class="form-control" name="fecha" value="<?php echo$fecha;?>">
						</td>
					</tr>
					<tr>
						<td>No. Acta</td>
